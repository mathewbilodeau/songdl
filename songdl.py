...
class Songdl(tk.Tk):
    ...
    def __init__(self):
        ...
        ttk.Combobox(self.frame, textvariable=self.track_number_string_variable, values=track_number_list).grid(column=1, row=6)
        ...
        # Row 10
        self.download_button = ttk.Button(self.frame, width=20, text="Download", command=self.download_song_and_update_metadata)
        self.download_button.grid(column=1, row=10)

        # Row 11
        self.clear_fields_button = ttk.Button(self.frame, width=20, text="Clear Fields", command=self.revert_text_fields)
    ...
    def download_song_and_update_metadata(self):
        ...
        self.update_metadata(full_file_path, 
                                ...
                                contributing_artists=self.contributing_artists_string_variable.get().replace(self.RECOMMENDED_FIELD_DEFAULT, ""),
